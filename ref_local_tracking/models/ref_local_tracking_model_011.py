...
def ref_local_tracking_model_011(
    ...
    l4_up_1 = UpSampling2D(interpolation="nearest")(ref_local_l4_1)
    ...
    l4_up_2 = UpSampling2D(interpolation="nearest")(ref_local_l4_2)
    ...
    l4_up_3 = UpSampling2D(interpolation="nearest")(ref_local_l4_3)
    ...
    merge_layer = Conv2D(
        30, 1, activation="relu", padding="same", kernel_initializer="he_normal",
    )(merge_layer)
