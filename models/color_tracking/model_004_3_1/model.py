from color_tracking.models.model_004_3_1.loss import CustomCategoricalCrossentropy
...
def model(
    ...
    # 파라미터
    unet_filters: int = 16
    filters: int = 8  # 메모리 용량의 한계로 인한 필터 수 감소
    ...
    # l4_conv_up_1: Layer = Activation("softmax")(l4_conv_up_1)
    ...
    # l4_conv_up_2: Layer = Activation("softmax")(l4_conv_up_2)
    ...
    # l4_conv_up_3: Layer = Activation("softmax")(l4_conv_up_3)
