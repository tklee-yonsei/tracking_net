...
def model(
    ...
    total_conv_1st: Layer = Conv2D(
        bin_num, 1, activation="relu", padding="same", kernel_initializer="he_normal"
    )(l4_conv_1)
    total_conv_1st: Layer = Activation("softmax")(total_conv_1st)
    ...
    total_conv_2nd: Layer = Conv2D(
        bin_num, 1, activation="relu", padding="same", kernel_initializer="he_normal"
    )(l4_conv_2)
    total_conv_2nd: Layer = Activation("softmax")(total_conv_2nd)
    ...
    total_conv_3rd: Layer = Conv2D(
        bin_num, 1, activation="relu", padding="same", kernel_initializer="he_normal"
    )(l4_conv_3)
    total_conv_3rd: Layer = Activation("softmax")(total_conv_3rd)
    ...
    model: Model = Model(
        ...
        outputs=[total_conv_1st, total_conv_2nd, total_conv_3rd, total_conv],
    )
