...
from ref_local_tracking.models.backbone.unet_l4_leaky import unet_l4_leaky
from ref_local_tracking.models.ref_local_tracking_model_022_2 import (
    ref_local_tracking_model_022_2,
)
...
if __name__ == "__main__":
    # 1. Variables --------
    # 모델 이름
    model_name: str = "ref_local_tracking_model_022_2"
    # 트레이닝 배치 크기
...
""".format(
    ...
    with strategy.scope():
        ...
        model = ref_local_tracking_model_022_2(
