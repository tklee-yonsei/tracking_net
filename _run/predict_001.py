...
from models.ref_local_tracking.ref_local_tracking_model_002.config import (
    generate_color_map,
    single_generator,
...
if __name__ == "__main__":
    ...
    weights_path: str = os.path.join(
        save_weights_folder,
        "training__model_ref_local_tracking_model_002__run_20201013-141113.epoch_41-val_loss_0.096-val_acc_0.971.hdf5",
    )
