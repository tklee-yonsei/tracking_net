...
from models.ref_local_tracking.ref_local_tracking_model_004.model import (
    ref_local_tracking_model_004,
)
...
ref_local_tracking_model_004_model_descriptor_default: ModelDescriptor = ModelDescriptor(
    inputs=[
...
model004_loss_descriptors_default: List[LossDescriptor] = [
...
class RefModel004ModelHelper(ModelHelper):
    def __init__(
        self,
        pre_trained_unet_l4_model: Model,
        model_descriptor: ModelDescriptor = ref_local_tracking_model_004_model_descriptor_default,
        alpha: float = 1.0,
    ):
    ...
    def get_model(self) -> Model:
        return ref_local_tracking_model_004(
    ...
    def compile_model(
        ...
        loss_list: List[LossDescriptor] = model004_loss_descriptors_default,
...
def single_input_main_image_preprocessing(
    ...
    resize_to = ref_local_tracking_model_004_model_descriptor_default.get_input_sizes()[
        1
    ]
