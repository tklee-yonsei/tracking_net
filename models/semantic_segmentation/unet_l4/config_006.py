...
def binary_boundary_crossentropy(
    ...
    importance_within_area = tf.reshape(
        importance_within_area, (-1, tf.shape(y_true)[1], tf.shape(y_true)[2], 1)
    )
    importance_within_area = importance_within_area * 0.01

    diff_ratio = diff_ratio * importance_of_area * importance_within_area
