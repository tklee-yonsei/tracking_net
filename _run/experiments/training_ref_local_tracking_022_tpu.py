...
from ref_local_tracking.models.ref_local_tracking_model_022 import (
    ref_local_tracking_model_022,
)
...
if __name__ == "__main__":
    # 1. Variables --------
    # 모델 이름
    model_name: str = "ref_local_tracking_model_022"
    # 트레이닝 배치 크기
...
""".format(
    ...
    with strategy.scope():
        ...
        model = ref_local_tracking_model_022(
