...
from ref_local_tracking_m.models.test_ref_local_tracking_model_025_aux import (
...
# python3 ref_local_tracking_m/run/test_predict.py \
...
""".format(
    ...
    for predict_data in predict_test_dataset:
        ...
        np.save(
            "/home/tklee/results/{}_input_prev.npy".format(filename),
            predict_data[0][2],
        )
        ...
        np.save("/home/tklee/results/{}_0.npy".format(filename), predicted[0][0])
        np.save("/home/tklee/results/{}_1.npy".format(filename), predicted[1][0])
