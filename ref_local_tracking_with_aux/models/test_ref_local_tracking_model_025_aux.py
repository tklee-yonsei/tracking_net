"""
중간 레이어 비교 테스트를 위한 모델
"""

from typing import Tuple

from layers.aggregation_layer import AggregationLayer
from layers.test_ref_local_layer8 import RefLocal8
...
def test_ref_local_tracking_model_025_aux(
    ...
    return Model(
        ...
        outputs=[diff_local1, diff_agg1, diff_agg2, diff_agg3, diff_agg4],
    )
