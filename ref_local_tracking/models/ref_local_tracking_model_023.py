...
def ref_local_tracking_model_023(
    ...
    main_unet_model = get_unet_layer(pre_trained_unet_l4_model_main)
    ref_unet_model = get_unet_layer(pre_trained_unet_l4_model_ref)
