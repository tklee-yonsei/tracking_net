...
def ref_local_tracking_model_004(
    ...
    ref_local_l4_1: Layer = RefLocal(mode="dot", k_size=7, bin_size=bin_num)(
    ...
    ref_local_l4_2: Layer = RefLocal2(mode="dot", k_size=7, bin_size=bin_num)(
    ...
    ref_local_l4_3: Layer = RefLocal2(mode="dot", k_size=7, bin_size=bin_num)(
    ...
    ref_local_l4_4: Layer = RefLocal2(mode="dot", k_size=7, bin_size=bin_num)(
